...
PF_model = 'PF_M2'  # PF_M1, PF_M2
retention_base_folder = r'E:\PhD Study\SimCTM\SctmTest\RetentionTestNew'
main_prj_name = 'Temperature'
trap_occupy = 'Half'  # Half, Full
prj_list = ['300K', '350K', '400K', '450K', '500K']
...
ax_edens.set_ylim(1, 1e5)
ax_edens.set_yscale('log')
ax_edens.legend(labels, loc='upper left')

# all the axes

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Temp_vfb_' + trap_occupy)
fig_vfb.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Temp_occ_' + trap_occupy)
fig_occ.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Temp_dens_' + trap_occupy)
