...
main_prj_name = 'eMassTrap'
trap_occupy = 'Full'  # Half, Full
prj_list = ['0.20', '0.30', '0.40', '0.50', '0.60']
...
# all the axes
fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', 'T2B_Mass_' + trap_occupy + '_vfb')
fig_vfb.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', 'T2B_Mass_' + trap_occupy + '_occ')
fig_occ.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', 'T2B_Mass_' + trap_occupy + '_edens')
