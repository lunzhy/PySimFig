...
fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Freq_vfb_' + trap_occupy)
fig_vfb.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Freq_occ_' + trap_occupy)
fig_occ.savefig(fig_name, dpi=1020, bbox_inches='tight', pad_inches=0.1)

fig_name = os.path.join(r'E:\PhD Study\SimCTM\SctmTest\figures', PF_model + '_Freq_dens_' + trap_occupy)
